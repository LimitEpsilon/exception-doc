...
Comments: Note that even though id is called two times, there are two variables corresponding to id, which are $V(e_{211},[\text{id}\mapsto e_{1}])$ and $V(e_{221},[\text{id}\mapsto e_{1}])$.
